device="${1:-0}"
comment="${2:-''}"
CUDA_VISIBLE_DEVICES=${device} sudo /data/czl/anaconda3/envs/gs/bin/ncu \
    --profile-from-start off \
    -f -o profile_outputs/ncu_${comment} \
    ...
    /data/czl/anaconda3/envs/gs/bin/python main_sh.py wandb=False max_iteration=1 only_forward=True
